...
public class MoreChartBase extends VoltsAmpsHertzBaseView {
    protected final int XRangeMaximum = 100;
    protected final int labelCount = 10;
    protected String unit = "";

    public MoreChartBase(Context context) {
        super(context);
    }

    public MoreChartBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MoreChartBase(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public MoreChartBase(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
