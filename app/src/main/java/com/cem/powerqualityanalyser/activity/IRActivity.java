...
public class IRActivity extends BaseActivity implements View.OnClickListener {
  ...
  //      public_bottom.setVisibility(View.GONE);
    ...
    protected List<BaseBottomAdapterObj> initBottomData() {
        ...
        data.add(new BaseBottomAdapterObj(Res2String(R.string.setup_overview)));
        data.add(new BaseBottomAdapterObj(Res2String(R.string.setup_system)));
        data.add(new BaseBottomAdapterObj(Res2String(R.string.setup_conect)));
        data.add(new BaseBottomAdapterObj(Res2String(R.string.setup_freq)));
        data.add(new BaseBottomAdapterObj(Res2String(R.string.setup_info)));
        return data;
    }
