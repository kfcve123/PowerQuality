...
import com.cem.powerqualityanalyser.chart.VoltsAmpsHertzBaseView;
...
public class VoltAmpsMoreChartBase extends VoltsAmpsHertzBaseView {
    protected final int XRangeMaximum = 100;
    protected final int labelCount = 10;
    protected String unit = "";

    public VoltAmpsMoreChartBase(Context context) {
        super(context);
    }

    public VoltAmpsMoreChartBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public VoltAmpsMoreChartBase(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public VoltAmpsMoreChartBase(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
