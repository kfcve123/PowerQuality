 ...
 * 新的
 */
public class DipsSwellsTrendView extends DipsSwellsMoreChartBase {

    private boolean newData;

    public DipsSwellsTrendView(Context context) {
        super(context);
    }

    public DipsSwellsTrendView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DipsSwellsTrendView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public DipsSwellsTrendView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setDipsTopView(float textSize, String s) {
    ...
    /*public void setDipsModeIndex(int wir_index,int wir_right_index,int positio) {
        switch (wir_index) {
            case 9://1Q +NEUTRAL
     ...
     * @param positio
     */
    public void setDipsCursorIndex(int wir_index,int wir_right_index,int positio) {
        switch (wir_index) {
            case 9://1Q +NEUTRAL
                switch (wir_right_index) {//切换右边选项
                    case 0://2V
