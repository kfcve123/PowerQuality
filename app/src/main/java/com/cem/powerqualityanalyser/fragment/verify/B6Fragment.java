...
public class B6Fragment extends Fragment implements View.OnClickListener {
    ...
    public void setData2View(List<ModelBaseData> listB6){
        if(!listB6.isEmpty()){
            tv_phaseA_v.setText(listB6.get(0).getValue());
            if(listB6.size()>1) {
                tv_phaseB_v.setText(listB6.get(1).getValue());
                if (listB6.size() > 2) {
                    tv_phaseC_v.setText(listB6.get(2).getValue());
                    if (listB6.size() > 3) {
                        tv_phaseN_v.setText(listB6.get(3).getValue());
                        if (listB6.size() > 4) {
                            tv_phaseA_peakV.setText(listB6.get(4).getValue());
                            if (listB6.size() > 5) {
                                tv_phaseB_peakV.setText(listB6.get(5).getValue());
                                if (listB6.size() > 6) {
                                    tv_phaseC_peakV.setText(listB6.get(6).getValue());
                                    if (listB6.size() > 7) {
                                        tv_hz.setText(listB6.get(7).getValue());
                                    }
                                }
                            }
                        }
