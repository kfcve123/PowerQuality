...
public class UnbalanceMoreChartBase extends UnbalanceTrendBaseView {
    protected final int XRangeMaximum = 100;
    protected final int labelCount = 10;
    protected String unit = "";

    public UnbalanceMoreChartBase(Context context) {
        super(context);
    }

    public UnbalanceMoreChartBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public UnbalanceMoreChartBase(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public UnbalanceMoreChartBase(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
