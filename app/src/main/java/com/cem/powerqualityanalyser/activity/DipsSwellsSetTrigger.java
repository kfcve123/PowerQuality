...
/**
 * 暂升暂降 参数设置  Volt lever: 0 到 7 ，0.01 一加
 */
public class DipsSwellsSetTrigger extends BaseFragmentTrend implements AmountViewHorizontal.OnHorizonalAmountChangeListener {
    ...
    public void onInitView() {
        ...
        vlot_amountview.setAmount(1);
        vlot_amountview.setContent(showItems[0]);
        ...
        amp_amountview.setAmount(1);
        amp_amountview.setContent(showItems2[0]);
