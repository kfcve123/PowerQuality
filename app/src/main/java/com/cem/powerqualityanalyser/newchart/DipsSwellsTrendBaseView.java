...
public class DipsSwellsTrendBaseView extends MPChartBaseView implements OnChartValueSelectedListener {
    ...
    public DipsSwellsTrendBaseView(Context context) {
        super(context);
    }

    public DipsSwellsTrendBaseView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public DipsSwellsTrendBaseView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public DipsSwellsTrendBaseView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
