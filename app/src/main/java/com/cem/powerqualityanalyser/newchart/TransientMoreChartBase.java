...
public class TransientMoreChartBase extends TransientTrendBaseView {
    protected int XRangeMaximum = 100;
    protected final int labelCount = 10;
    protected String unit = "";

    public TransientMoreChartBase(Context context) {
        super(context);
    }

    public TransientMoreChartBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TransientMoreChartBase(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public TransientMoreChartBase(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
