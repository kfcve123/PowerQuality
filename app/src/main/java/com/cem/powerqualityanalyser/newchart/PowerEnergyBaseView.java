...
public class PowerEnergyBaseView extends MPChartBaseView implements OnChartValueSelectedListener {
    ...
    public PowerEnergyBaseView(Context context) {
        super(context);
    }

    public PowerEnergyBaseView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PowerEnergyBaseView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public PowerEnergyBaseView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    @Override
    protected void setLineCharAttribute() {
        rootView = (RelativeLayout) inflater.inflate(R.layout.powerenergy_trend_view_layout, this);
