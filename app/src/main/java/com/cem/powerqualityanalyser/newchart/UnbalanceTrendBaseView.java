...
public class UnbalanceTrendBaseView extends MPChartBaseView implements OnChartValueSelectedListener{
    ...
    protected RelativeLayout inrushchart_rl,linechart_n_rl;
    ...
    protected TextView inrush_config_tv,tv_hz;
    protected int[] imgid;
    ...
    public UnbalanceTrendBaseView(Context context) {
        super(context);
    }

    public UnbalanceTrendBaseView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public UnbalanceTrendBaseView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public UnbalanceTrendBaseView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void setLineCharAttribute() {
        ...
        iv_time = rootView.findViewById(R.id.iv_time);
        tv_time = rootView.findViewById(R.id.tv_time);
        tv_time.setVisibility(INVISIBLE);
        iv_time.setVisibility(INVISIBLE);
        ...
        inrushchart_rl = findViewById(R.id.inrushchart_rl);
