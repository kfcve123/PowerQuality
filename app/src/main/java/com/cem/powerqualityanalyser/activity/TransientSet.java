 ...
 */
public class TransientSet extends BaseFragmentTrend implements AmountViewHorizontal.OnHorizonalAmountChangeListener {
...
//        vlot_amountview.setFocusableInTouchMode(true);
    ...
    public int setContentView() {
        return R.layout.fragment_transientset;
    }
    ...
    public void onInitView() {
        ...
        if(AppConfig.getInstance().isTransientSet_Default()){
            ...
            amountValue_time = config.getTransient_Time_Year();
            amountValue_time2 = config.getTransient_Time_Month();
            amountValue_time3 = config.getTransient_Time_Day();
            amountValue_time4 = config.getTransient_Time_Hours();
            amountValue_time5 = config.getTransient_Time_Minutes();
            transient_time_default = config.isTransient_Time_Immediate();
    ...
    public void saveSetting(){
        ...
        config.setTransient_Time_Year(amountValue_time);
        config.setTransient_Time_Month(amountValue_time2);
        config.setTransient_Time_Day(amountValue_time3);
        config.setTransient_Time_Hours(amountValue_time4);
        config.setTransient_Time_Minutes(amountValue_time5);
