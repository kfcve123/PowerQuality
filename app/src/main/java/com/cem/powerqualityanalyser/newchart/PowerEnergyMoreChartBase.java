...
public class PowerEnergyMoreChartBase extends PowerEnergyBaseView {
    protected final int XRangeMaximum = 100;
    protected final int labelCount = 10;
    protected String unit = "";

    public PowerEnergyMoreChartBase(Context context) {
        super(context);
    }

    public PowerEnergyMoreChartBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PowerEnergyMoreChartBase(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public PowerEnergyMoreChartBase(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
