...
public class VoltsAmpsHertzBaseView extends MPChartBaseView implements OnChartValueSelectedListener {
    ...
    protected RelativeLayout inrushchart_l1_rl, inrushchart_l2_rl, inrushchart_l3_rl, linechart_n_rl;
    ...
    public VoltsAmpsHertzBaseView(Context context) {
        super(context);
    }

    public VoltsAmpsHertzBaseView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public VoltsAmpsHertzBaseView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public VoltsAmpsHertzBaseView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//                showSelectValue(iLastEntry + i);
    ...
    public void zoomScale(float xScale, float yScale) {
        ...
        for (int i = 0; i < charts.size(); i++) {
            ...
            charts.get(i).fitScreen();
            matrix.postScale(xScale, yScale);
            charts.get(i).getViewPortHandler().refresh(matrix, charts.get(i), false);
        }
