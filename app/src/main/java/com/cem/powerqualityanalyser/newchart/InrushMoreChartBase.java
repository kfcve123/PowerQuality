...
public class InrushMoreChartBase extends InrushTrendBaseView {
    protected final int XRangeMaximum = 100;
    protected final int labelCount = 10;
    protected String unit = "";

    public InrushMoreChartBase(Context context) {
        super(context);
    }

    public InrushMoreChartBase(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public InrushMoreChartBase(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public InrushMoreChartBase(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
