...
public class HarmonicsBarChart extends BaseBarChart{

    public HarmonicsBarChart(Context context) {
        super(context);
    }

    public HarmonicsBarChart(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HarmonicsBarChart(Context context, AttributeSet attrs, int defStyle) {
