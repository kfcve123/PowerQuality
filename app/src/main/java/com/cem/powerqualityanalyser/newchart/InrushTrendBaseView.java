...
public class InrushTrendBaseView extends MPChartBaseView implements OnChartValueSelectedListener {
    ...
    public InrushTrendBaseView(Context context) {
        super(context);
    }

    public InrushTrendBaseView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public InrushTrendBaseView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public InrushTrendBaseView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void setLineCharAttribute() {
        ...
        textview_l1.setText("_ _ _._  A");
        textview_l2.setText("_ _ _._  A");
        textview_l3.setText("_ _ _._  A");
        textview_l4.setText("_ _ _._  A");
    ...
    public void setTimeView(boolean show){
        if(iv_time!=null)
            iv_time.setVisibility(show?VISIBLE:INVISIBLE);
    }
