 ...
 */
public class PowerMonitorSet extends BaseFragmentTrend implements AmountViewHorizontal.OnHorizonalAmountChangeListener {
...
//        amountview_minutes.setAmountViewLayout(250);
    ...
    public void moveCursor(int i) {
        log.e("===forbinUp===" + forbinUp);
        log.e("===forbinLeft===" + forbinLeft);
