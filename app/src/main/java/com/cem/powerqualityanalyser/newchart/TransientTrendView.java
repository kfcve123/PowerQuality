 ...
 * 新的
 */
public class TransientTrendView extends TransientMoreChartBase {

    private boolean newData;

    public TransientTrendView(Context context) {
        super(context);
    }

    public TransientTrendView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TransientTrendView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public TransientTrendView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setTransientTopView(float textSize, String s) {
    ...
    private void setMaxAndMinValue(List<Float> dataList){
        maxLeftTrendView = 0f;
        minLeftTrendView = 0f;
        float max = 0;
  ...
  //              chart.getXAxis().setLabelCount(XRangeMaximum);
                ...
                if (maxLeftTrendView <= 5f)
                    chart.getAxisLeft().setAxisMaximum(5 * 2);
                else if(maxLeftTrendView >5f && maxLeftTrendView <=400f)
                    chart.getAxisLeft().setAxisMaximum(maxLeftTrendView * 1.2f);
                else if(maxLeftTrendView >400f && maxLeftTrendView <=600f)
                    chart.getAxisLeft().setAxisMaximum(maxLeftTrendView * 1.5f);
                else
                    chart.getAxisLeft().setAxisMaximum(maxLeftTrendView * 2);

                if (minLeftTrendView >=-5f)
                    chart.getAxisLeft().setAxisMinimum(-5 * 2);
                else if(minLeftTrendView >=-400f && minLeftTrendView <-5f)
                    chart.getAxisLeft().setAxisMinimum(minLeftTrendView * 1.2f);
                else if(minLeftTrendView >=-600f && minLeftTrendView<-400f)
                    chart.getAxisLeft().setAxisMinimum(minLeftTrendView * 1.5f);
                else
...
//                          chart.moveViewToX(lineData.getEntryCount());
    ...
    public void setXRangeMaximum(int maxXRange){
        this.XRangeMaximum = maxXRange;
    }
