...
public class PowerEnergyView extends PowerEnergyMoreChartBase {

    private boolean newData;

    public PowerEnergyView(Context context) {
        super(context);
    }

    public PowerEnergyView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PowerEnergyView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public PowerEnergyView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setPowerEnergyTopView(float textSize, String s) {
